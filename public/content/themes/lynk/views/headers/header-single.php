...
if( is_single() ) {
    ...
    if( has_post_thumbnail() ) {
        $jvbpdSingleHeadeStyle = sprintf( 'style="background-image:url(%1$s);"', esc_url(get_the_post_thumbnail_url(null, 'full')));
    } ?>
    <div class="single-header-wrap header-<?php the_ID(); ?>">
        <div class="single-header-bg" <?php echo esc_attr($jvbpdSingleHeadeStyle);?>></div>
