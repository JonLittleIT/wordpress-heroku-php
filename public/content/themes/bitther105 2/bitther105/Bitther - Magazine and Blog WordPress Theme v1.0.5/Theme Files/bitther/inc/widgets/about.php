 ...
 **/
class bitther_about extends WP_Widget{
	...
	public function __construct() {
		...
		$widget_ops = array('classname' => 'about', 'description' => esc_html__('Easy add About.', 'bitther'));

		/* Create the widget. */
		parent::__construct('about', esc_html__('+NA: About', 'bitther'), $widget_ops, $control_ops);
	}
	/**
	 * font-end widgets
	 */
	...
	public function form($instance){
		$instance =   wp_parse_args($instance,array(
			'title'       =>  esc_html__('About','bitther'),
			'image'       => '',
			'description' =>'',
		));
		?>
...
function bitther_about(){
	register_widget('bitther_about');
}
add_action('widgets_init','bitther_about');
?>