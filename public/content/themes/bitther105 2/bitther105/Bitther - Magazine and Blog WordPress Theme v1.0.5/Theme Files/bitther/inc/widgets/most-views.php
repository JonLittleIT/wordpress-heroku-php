 ...
 * @license     GPL v2
 */
class bitther_most_views extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'bitther_most_views',__('+NA: Most Views','bitther'),
            array('description'=>__(' Most Views post for last week , month', 'bitther'))
        );
    }
...
function bitther_most_views(){
    register_widget('bitther_most_views');
}
add_action('widgets_init','bitther_most_views');
