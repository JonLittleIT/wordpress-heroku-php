<?php
  ...
  * widgets service
  **/
  class bitther_service extends WP_Widget{

      /*function construct*/
      public function __construct() {
          parent::__construct(
            'service',esc_html__('+NA: Services','bitther'),
             array('description'=>esc_html__('Display Services info', 'bitther'))
          );
      }
      /**
       * font-end widgets
      ...
      */
      public function form($instance){
          $instance =   wp_parse_args($instance,array(
              'icon'                => 'fa-truck',
              'title-service'       => esc_html__('Free shipping','bitther'),
              'link'                => '#',
              'description'         => esc_html__('Free Shipping Worldwide','bitther'),
          ));
          ?>
          <p>
              <label for=<?php echo esc_attr($this->get_field_id('icon')); ?>><?php esc_html_e('Icon service:','bitther') ; ?></label>
              ...
              <p><?php esc_html_e('Select icon from','bitther'); ?><a href="<?php echo esc_url( 'http://fortawesome.github.io/Font-Awesome/icons' ); ?>"> Font Awesome</a><p>
          </p>
          <p>
              <label for=<?php echo esc_attr($this->get_field_id('link')); ?>><?php esc_html_e('link service:','bitther') ; ?></label>
          ...
          <p>
              <label for="<?php echo esc_attr($this->get_field_id('title-service')); ?>"><?php esc_html_e( 'Title service:', 'bitther' ); ?></label>
          ...
          <!-- description -->
          <p>
              <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e('Description service:', 'bitther'); ?></label>
  ...
  function bitther_service(){
      register_widget('bitther_service');
  }
  add_action('widgets_init','bitther_service');
?>