<?php /* Header Type 1 */
	...
	$farvis_logo_stl .= farvis_get_option('general_settings_logo_padding_top') != '' ? 'padding-top:'.esc_attr(farvis_get_option('general_settings_logo_padding_top')).'px;' : '';
	$farvis_logo_stl .= farvis_get_option('general_settings_logo_padding_right') != '' ? 'padding-right:'.esc_attr(farvis_get_option('general_settings_logo_padding_right')).'px;' : '';
	$farvis_logo_stl .= farvis_get_option('general_settings_logo_padding_bottom') != '' ? 'padding-bottom:'.esc_attr(farvis_get_option('general_settings_logo_padding_bottom')).'px;' : '';
	$farvis_logo_stl .= farvis_get_option('general_settings_logo_padding_left') != '' ? 'padding-left:'.esc_attr(farvis_get_option('general_settings_logo_padding_left')).'px;' : '';
