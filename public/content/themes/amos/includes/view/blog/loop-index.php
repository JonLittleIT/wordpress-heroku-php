        ...
        //$cats = substr(trim($cats), 0, -1);
         ...
         ?>
                ...
                <div class="media">
                   ...
                   <div class="categories"> <?php echo wp_kses($cats , '', ''); ?></span></div>
                   <?php }?>
                    <?php if($post_format == 'audio'){
                ...
                <div class="content">
                    ...
                    <div class="text">
                    <?php if($post_format == 'quote'){ ?>
                    <a href="<?php echo esc_url(get_permalink()) ?>"><i class="moon-quotes-left"></i>
                    ...
                    <?php if(is_single()) amos_post_navtigations();?>
                    </div>
                    <?php if($post_format == 'quote'){ ?>
                        </a><span class="title">- <?php echo esc_html(get_the_title()) ?>
                ...
                <div class="extra_info">
                    ...
                    <?php if($amos_redata['blog_info_comments']): ?>                   
                                <div class="comment_count"><i class="lnr lnr-bubble"></i> <?php echo esc_attr($count) ?> <?php 
