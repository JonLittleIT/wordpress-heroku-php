        ...
        $cats = substr(trim($cats), 0, -1);
	     ?>
             ...
             <div class="timeline">
                    ...
                    <div class="date">
                    <span class="day"><?php $d= 'd'; the_time($d) ?></span><span class="month"><?php $M='M'; the_time($M) ?></span>
                     <?php if($amos_redata['blog_info_author']): ?>  
                    <div class="author_avatar"><?php echo get_avatar($post_id, '100') ?> </div>
                <?php endif;?>
                    </div>
             ...
             <div class="post_box <?php if($amos_redata['timeline_box_shadow']) echo 'box_shadow'; ?>">
