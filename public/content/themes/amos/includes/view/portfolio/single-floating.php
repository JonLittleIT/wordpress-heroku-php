...
<div class="container">
    <div class="row-fluid">
        ...
        <?php if($amos_redata['single_portfolio_content_position_floating'] == 'left'): ?>
        ...
        <div class="span9">
            <div class="media">
                <?php if(!empty($amos_redata['single_portfolio_gallery'])): foreach($amos_redata['single_portfolio_gallery'] as $slide): ?>
                    ...
                    <img src="<?php echo esc_url(amos_image_by_id($slide['attachment_id'], '', 'url'))  ?>" >
        ...
        <?php if($amos_redata['single_portfolio_content_position_floating'] == 'right'): ?>
            <div class="span3 fixed_sidebar">
                <div class="description">
                    <h4><?php _e('Project Description', 'amos') ?></h4>
                    <?php the_content(); ?>
