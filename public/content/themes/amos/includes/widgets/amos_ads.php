...
class AmosAdsWidget extends WP_Widget{
    ...
    function widget($atts, $instance){
        ...
        echo '<a href="'.esc_url($ad_url).'"><img style="'.$extra_style.'" src="'.esc_url($ad_img).'"   /></a>';
    ...
    function form($instance){
        ...
        <p>
    		...
    		<input id="<?php echo esc_attr($this->get_field_id('ad_url')); ?>" name="<?php echo esc_attr($this->get_field_name('ad_url')); ?>" type="text" value="<?php echo esc_attr($ad_url); ?>" /></label>
