jQuery('document').ready(function() {
    ...
    function yaWPWimModifyItem() {
        ...
        jQuery('#update-nav-menu .menu-item-muizz_wim p.description').not('p.field-move').hide();

        // hack to display settings message
        $message = jQuery('p.msg-muizz_sim').html();
        jQuery('#update-nav-menu .menu-item-muizz_wim p.link-to-original').html($message);
    }
