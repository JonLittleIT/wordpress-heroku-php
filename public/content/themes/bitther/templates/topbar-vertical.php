...
$configTopbar = str_replace('','',bitther_topbar_config() );
                        ...
                        <div class="user-login list-unstyled">
                            <div>
                                <?php if (!is_user_logged_in()) { ?>
                                    <span class="hidden-xs"><?php esc_html_e('Welcome ', 'bitther'); ?><a
                                            href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>"><?php echo esc_html__('Guest', 'bitther'); ?></a> !</span>
                                <?php } else { ?>
