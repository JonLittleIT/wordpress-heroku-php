<?php
  ...
  * widgets support
  **/
  class bitther_support extends WP_Widget{

      /*function construct*/
      public function __construct() {
          parent::__construct(
            'support',esc_html__('+NA: Support','bitther'),
             array('description'=>esc_html__('Display Support info', 'bitther'))
          );
      }
      /**
       * font-end widgets
      ...
      */
      public function form($instance){
          ...
          ?>
          <p>
              <label for=<?php echo esc_attr($this->get_field_id('icon')); ?>><?php esc_html_e('Icon:','bitther') ; ?></label>
          ...
          <p>
              <label for="<?php echo esc_attr($this->get_field_id('text-support')); ?>"><?php esc_html_e( 'Text support:', 'bitther' ); ?></label>
          ...
          <!-- description -->
          <p>
              <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e('Description:', 'bitther'); ?></label>
  ...
  function bitther_support(){
      register_widget('bitther_support');
  }
  add_action('widgets_init','bitther_support');
?>