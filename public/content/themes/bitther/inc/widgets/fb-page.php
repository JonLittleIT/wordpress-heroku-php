...
class wide_fb_page extends WP_Widget{
    ...
    public function __construct() {
        parent::__construct(
            'fb_page',esc_html__('+NA: Facebook Page','bitther'),
            array('description'=>esc_html__('Facebook Page', 'bitther'))
        );
    }
    /**
     * font-end widgets
    ...
    public function form($instance){
        $instance =   wp_parse_args($instance,array(
            'title'       =>  esc_html__('Find us on facebook','bitther'),
            'address'     =>  '',
        ));
        ?>
        <p>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php echo esc_html_e('Link address your facebook:','bitther'); ?></label>
