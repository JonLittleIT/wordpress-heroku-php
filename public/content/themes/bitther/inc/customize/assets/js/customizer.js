(function ($) {
    ...
    $(document).ready(function() {
        ...
        controlSlider.each( function() {
            var inputField = $(this).find( '.bitther-slider-range-input' ),
                sliderRange = $(this).find( '.bitther-slider-range' );

            $(this).find('.bitther-slider-range').slider({
                range: "min",
        ...
        $( '.bitther-slider-range-input' ).on( 'keyup paste', function() {
            $(this).change();
        ...
        $( '.bitther-slider-range-input' ).on( 'change', function() {
