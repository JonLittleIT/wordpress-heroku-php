...
if(isset($primary_hover) && $primary_hover){
    $cssCode .= <<<CSS
        .bd-b-primary_hover {
    border-bottom-color: $primary_hover; 
}
CSS;
...
if(isset($primary_hover) && $primary_hover){
    $cssCode .= <<<CSS
        .bd-r-primary_hover {
    border-right-color: $primary_hover; 
}
CSS;
...
.input-text::-webkit-input-placeholder, select:not([size]):not([multiple]), .wpml-ls-statics-footer li a, .ekommart-canvas-filter a:not(.button),
...
.input-text:-ms-input-placeholder, select:not([size]):not([multiple]), .wpml-ls-statics-footer li a, .ekommart-canvas-filter a:not(.button),
.widget-area a:not(.button) {
    color: $body; 
}
CSS;
...
if(isset($background) && $background){
    $cssCode .= <<<CSS
        body, .ekommart-layout-boxed #page, .bg-background, .site-header, .site-header-account .account-dropdown .account-wrap, .header-9 .header-container, .header-sticky, .main-navigation .sub-menu, .vertical-navigation ul.menu, .site-footer, input[type='text'],
input[type='number'],
input[type='email'],
input[type='tel'],
input[type='url'],
...
if(isset($background2) && $background2){
    $cssCode .= <<<CSS
        .bd-b-background2 {
    border-bottom-color: $background2; 
}
CSS;
...
if(isset($background2) && $background2){
    $cssCode .= <<<CSS
        .bd-r-background2 {
    border-right-color: $background2; 
}
CSS;
...
if(isset($white) && $white){
    $cssCode .= <<<CSS
        .color-white, .header-3 .site-welcome, .header-3 .ekommart-language-switcher span, button,
input[type='button'],
input[type='reset'],
input[type='submit'],
.button,
...
if(isset($white) && $white){
    $cssCode .= <<<CSS
        .bg-white, .ekommart-language-switcher .sub-item {
