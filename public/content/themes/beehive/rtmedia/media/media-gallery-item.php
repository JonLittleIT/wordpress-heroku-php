...
<li class="rtmedia-list-item animate-item slideInUp" id="<?php echo rtmedia_id(); // @codingStandardsIgnoreLine ?>">

	<?php do_action( 'rtmedia_before_item' ); ?>

	<a href="<?php rtmedia_permalink(); ?>" title="<?php echo esc_attr( rtmedia_title() ); ?>" class="<?php echo esc_attr( apply_filters( 'rtmedia_gallery_list_item_a_class', 'rtmedia-list-item-a' ) ); ?>">
		...
		<div class="rtmedia-item-thumbnail">
			...
			<img src="<?php rtmedia_image( 'rt_media_single_image' ); ?>" alt="<?php echo esc_attr( apply_filters( 'rtmc_change_alt_text', $alt_text, $rtmedia_media ) ); ?>">
		</div>
