...
<?php if ( is_user_logged_in() ) : ?>
	...
	<fieldset class="fieldset-login_required job-manager-message job-manager-info">
		...
		<div class="field account-sign-in">
			...
			<?php endif; ?>
			<a class="login color-primary" href="<?php echo esc_url( apply_filters( 'submit_job_form_login_url', wp_login_url( get_permalink() ) ) ); ?>"><?php esc_html_e( 'Sign in', 'wp-job-manager' ); ?></a>
		</div>
	</fieldset>
	<?php
