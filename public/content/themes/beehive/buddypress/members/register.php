...
?>
	...
	<div id="register-page"class="page register-page">
		...
		<h2 class="register-page-title">
			<?php esc_html_e( 'Create an Account', 'beehive' ); ?>
		</h2>
		...
		<?php bp_nouveau_template_notices(); ?>
			...
			<?php if ( 'request-details' === bp_get_current_signup_step() ) : ?>
				...
				<?php if ( bp_is_active( 'xprofile' ) && bp_nouveau_base_account_has_xprofile() ) : ?>
					...
					<div class="register-section extended-profile
					<?php
					if ( beehive()->options->get( 'key=hide-visibility-toggles&default=1' ) ) {
						echo ' hide-toggles';}
					?>
				...
				<?php if ( bp_get_blog_signup_allowed() ) : ?>
					...
					<div class="register-section blog-details" id="blog-details-section">
						...
						<h2 class="bp-heading"><?php esc_html_e( 'Site Details', 'buddypress' ); ?></h2>
