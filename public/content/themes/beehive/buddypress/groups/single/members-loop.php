...
<?php if ( bp_group_has_members( bp_ajax_querystring( 'group_members' ) ) ) : ?>
	...
	<ul id="members-list" class="<?php bp_nouveau_loop_classes(); ?>">
		...
		while ( bp_group_members() ) :
			...
			<li <?php bp_member_class( array( 'item-entry', 'animate-item', 'slideInUp' ) ); ?> data-bp-item-id="<?php echo esc_attr( bp_get_group_member_id() ); ?>" data-bp-item-component="members">
						...
						<div class="item-block">
							...
							<p class="latest-update">
								<?php if ( strlen( $beehive_user_update ) > 48 ) : ?>
									<?php echo esc_html( substr( $beehive_user_update, 0, 45 ) . '...' ); ?>
								<?php else : ?>
									<?php echo esc_html( $beehive_user_update ); ?>
								<?php endif; ?>
							</p>
