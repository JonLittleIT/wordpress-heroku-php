...
<div class="group-front-page">
		...
		<?php if ( ! is_customize_preview() && bp_current_user_can( 'bp_moderate' ) ) : ?>
			...
			<div class="bp-feedback custom-homepage-info info no-icon">
				...
				printf(
					...
					esc_url( bp_nouveau_groups_get_customizer_option_link() ),
					esc_url( bp_nouveau_groups_get_customizer_widgets_link() )
				);
				?>
				</p>
	...
	<?php if ( is_active_sidebar( 'sidebar-buddypress-groups' ) ) : ?>
		<aside id="group-front-widgets" class="bp-sidebar widget-area bp-widget-area" role="complementary">
