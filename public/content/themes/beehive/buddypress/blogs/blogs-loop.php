...
<?php if ( bp_has_blogs( bp_ajax_querystring( 'blogs' ) ) ) : ?>
	...
	while ( bp_blogs() ) :
		...
		<li <?php bp_blog_class( array( 'item-entry animate-item slideInUp' ) ); ?>>
			<div class="list-wrap">
				...
				<div class="item">
					...
					<div class="item-block">
						...
						<h4 class="list-title blogs-title"><a href="<?php bp_blog_permalink(); ?>"><?php bp_blog_name(); ?></a></h4>

						<p class="last-activity item-meta mute"><?php bp_blog_last_active(); ?></p>
