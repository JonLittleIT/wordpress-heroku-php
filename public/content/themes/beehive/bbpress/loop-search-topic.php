...
<div class="bbp-topic-header animate-item slideInUp">
	...
	<div class="bbp-topic-title">
		...
		<div class="bbp-topic-title-meta">
			...
			<a href="<?php bbp_forum_permalink( bbp_get_topic_forum_id() ); ?>" class="color-primary"><?php bbp_forum_title( bbp_get_topic_forum_id() ); ?></a>
