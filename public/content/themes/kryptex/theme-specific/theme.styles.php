...
if (!function_exists('kryptex_customizer_get_css')) {

	function kryptex_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = kryptex_customizer_add_theme_fonts($fonts);
...
.kryptex_tabs .kryptex_tabs_titles li a {
...
.sc_layouts_currency .currency_item ul,
...
.tp-tabs.inner.hebe .tp-tab-desc,
.tp-tabs.inner.hebe .tp-tab-title {
	{$fonts['h1_font-family']}
}

CSS;
			$rez = apply_filters('kryptex_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(kryptex_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = kryptex_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = kryptex_customizer_add_theme_colors($colors);
...
.cryptodonation-widget .cryptodonation-widget-info {	
...
input[placeholder]::-webkit-input-placeholder 		{ color: {$colors['input_text']}; opacity: 1; }
textarea[placeholder]::-webkit-input-placeholder	{ color: {$colors['input_text']}; opacity: 1; }
input[placeholder]::-moz-placeholder				{ color: {$colors['input_text']}; opacity: 1; }
textarea[placeholder]::-moz-placeholder				{ color: {$colors['input_text']}; opacity: 1; }
input[placeholder]:-ms-input-placeholder			{ color: {$colors['input_text']}; opacity: 1; }
textarea[placeholder]:-ms-input-placeholder			{ color: {$colors['input_text']}; opacity: 1; }
input[placeholder]::placeholder						{ color: {$colors['input_text']}; opacity: 1; }
textarea[placeholder]::placeholder					{ color: {$colors['input_text']}; opacity: 1; }



input[placeholder]:focus::-webkit-input-placeholder 		{ color: {$colors['input_dark']}; opacity: 1; }
textarea[placeholder]:focus::-webkit-input-placeholder	{ color: {$colors['input_dark']}; opacity: 1; }
input[placeholder]:focus::-moz-placeholder				{ color: {$colors['input_dark']}; opacity: 1; }
textarea[placeholder]:focus::-moz-placeholder				{ color: {$colors['input_dark']}; opacity: 1; }
input[placeholder]:focus:-ms-input-placeholder			{ color: {$colors['input_dark']}; opacity: 1; }
textarea[placeholder]:focus:-ms-input-placeholder			{ color: {$colors['input_dark']}; opacity: 1; }
input[placeholder]:focus::placeholder						{ color: {$colors['input_dark']}; opacity: 1; }
textarea[placeholder]:focus::placeholder					{ color: {$colors['input_dark']}; opacity: 1; }
...
button:hover:after,
.sc_button:hover .sc_button_icon {
	color: {$colors['inverse_link']};
}
...
.sc_layouts_row_type_narrow.sc_layouts_row_delimiter,
.scheme_self.sc_layouts_row_type_narrow.sc_layouts_row_delimiter {
	border-color: {$colors['alter_bd_color']};
}
...
.sc_layouts_row_type_normal .sc_layouts_item a:hover .sc_layouts_item_details span {
	color: {$colors['text_hover']};
}
...
.flex_header .sc_layouts_item_details_line1,
.flex_header .sc_layouts_item_details_line2,
.scheme_self.flex_header .sc_layouts_item_details_line1,
.scheme_self.flex_header .sc_layouts_item_details_line2 {
	color: {$colors['text_dark']};
}
...
.crtools-graph .fiat-button.active {
	border: 2px solid {$colors['alter_hover']}!important;
}
...
.sc_layouts_row_type_normal .search_wrap .search_wrap .search_submit:before,
.scheme_self.sc_layouts_row_type_normal .search_wrap .search_submit:before {
	color: {$colors['text_dark']};
}
.sc_layouts_row_type_normal .search_wrap .search_wrap .search_submit:hover:before,
...
.sc_layouts_row_type_compact .search_wrap.search_style_normal .search_submit:before,
.scheme_self.sc_layouts_row_type_compact .search_wrap.search_style_normal .search_submit:before,
.sc_layouts_row_type_compact .search_wrap.search_style_normal .search_submit,
.scheme_self.sc_layouts_row_type_compact .search_wrap.search_style_normal .search_submit {
	color: {$colors['text_hover']};
}
.sc_layouts_row_type_compact .search_wrap.search_style_normal .search_submit:hover:before,
.scheme_self.sc_layouts_row_type_compact .search_wrap.search_style_normal .search_submit:hover:before,
...
div.content form.mc4wp-form .mcfwp-agree-input a{
    color: {$colors['text_hover']};
}
...
div.content form.mc4wp-form .mcfwp-agree-input a:hover {
    color: {$colors['text_dark']};
}
...
span.trx_addons_login_link:hover .sc_layouts_item_icon {
	color: {$colors['text_hover']};
}
...
.sc_layouts_row_type_narrow .search_wrap .search_field::placeholder {
	color: {$colors['text_hover']};
}
...
.sc_layouts_row_type_compact .search_wrap .search_field::placeholder {
	color: {$colors['text_hover']};
}
...
.kryptex_tabs .kryptex_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.kryptex_tabs .kryptex_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sidebar h1 a,  h2 a, .sidebar h3 a, .sidebar h4 a, .sidebar h5 a, .sidebar h6 a {
	color: {$colors['alter_dark']};
}
...
.widget_recent_posts .wrap_hover {
	background-color: {$colors['alter_bg_color']};
}
...
.widget_area .post_item .post_categories a, aside .post_item .post_categories a {
	color: {$colors['text_hover']};
	border-color: {$colors['text_hover']};
}
.sc_recent_news .post_item .post_categories a:hover,
...
.widget_recent_posts .post_item.with_thumb:hover .post_title a,
.widget_recent_posts .post_item.with_thumb:hover .post_info a {
	color: {$colors['inverse_link']};
}
.widget_recent_posts .post_item.with_thumb:hover .post_title a:hover,
.widget_recent_posts .post_item.with_thumb:hover .post_info a:hover {
	color: {$colors['text_hover']};
}
.widget_recent_posts .post_item.with_thumb:hover .post_categories a {
	color: {$colors['text_hover']};
	border-color: {$colors['text_hover']};
}
.widget_recent_posts .post_item.with_thumb:hover .post_categories a:hover {
	color: {$colors['inverse_link']};
	border-color: {$colors['inverse_link']};
}
.sc_recent_news.sc_recent_news_style_news-excerpt .post_item .post_featured > a:hover:after {
	border-color: {$colors['text_hover']};
}
.post_meta_item.post_categories a {
	color: {$colors['text_hover']};
...
.trx_addons_popup_form_wrap .submit_button {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
...
.search_style_fullscreen.search_opened .search_field::placeholder	 {
	color: {$colors['text_dark']} !important;
	opacity: 1;
}
.sc_action_item_link {
...
.sc_action_item_simple.with_image .sc_action_item_link:hover,
.sc_action_item_default.with_image .sc_action_item_link:hover,
...
.btc_calculator .select_container:focus:after,
.btc_calculator .select_container:hover:after {
	color: {$colors['text_dark']} !important;
}
.btc_prices_table table td + td  {
	color: {$colors['text_dark']};
}
...
.sc_currency_item_button .sc_button {
	color: {$colors['inverse_link']} !important;
	background-color: {$colors['text_link']} !important;
}
.sc_currency_item_button .sc_button:hover {
	color: {$colors['inverse_link']} !important;
	background-color: {$colors['text_hover']} !important;
}
.sc_currency_item_button .sc_button:before {
	background-color: {$colors['text_link2']} !important;
}
...
.sc_recent_news.sc_recent_news_style_news-announce .post_item:hover .post_featured_bg .post_thumb:after,
.sc_recent_news.sc_recent_news_style_news-portfolio .post_item:hover .post_featured_bg .post_thumb:after {
...
CSS;
					...
					$rez = apply_filters('kryptex_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'kryptex_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>