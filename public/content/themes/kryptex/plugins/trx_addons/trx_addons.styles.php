...
if (!function_exists('kryptex_trx_addons_get_css')) {
	add_filter('kryptex_filter_get_css', 'kryptex_trx_addons_get_css', 10, 4);
	function kryptex_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.sc_services_hover [class*="column-"] .sc_services_item.with_image .sc_services_item_header.without_image,
.sc_services_hover .slider-slide .sc_services_item.with_image .sc_services_item_header.without_image {
	background-color:{$colors['text_dark']};
}
...
.sc_services_extra .sc_services_item_title .sc_services_item_number,
...
.sc_services_extra .sc_services_item_title a:hover .sc_services_item_number {
	color: {$colors['inverse_link']};	
}
...
.sc_services_extra .sc_services_item_link:hover {
	color: {$colors['inverse_link']};
...
/* Pagination crypto rocket */
.crtools-graph .sg-buttons .period-button.active,
div.dataTables_wrapper div.dataTables_paginate ul.pagination li.active a {
	color: {$colors['inverse_link']};
	border-color: {$colors['text_link']};
	background-color: {$colors['text_link']};
}
.crtools-graph .sg-buttons .period-button:hover,
div.dataTables_wrapper div.dataTables_paginate ul.pagination li a:hover {
	color: {$colors['inverse_link']};
	border-color: {$colors['text_hover']};
	background-color: {$colors['text_hover']};
}
.crtools-graph .sg-buttons .period-button,
...
.sc_socials_icons_names .socials_wrap .social_item:hover .social_name,
...
.widget_aboutme .aboutme_username i {
	color: {$colors['text_hover']};
}
