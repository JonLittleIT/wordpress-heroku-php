...
if ( !function_exists( 'kryptex_woocommerce_get_css' ) ) {
	add_filter( 'kryptex_filter_get_css', 'kryptex_woocommerce_get_css', 10, 4 );
	function kryptex_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
.woocommerce .shop_mode_thumbs ul.products li.product .post_item .post_featured,
.woocommerce-page .shop_mode_thumbs ul.products li.product .post_item .post_featured {
...
.post_item_single .summary .price span,
.woocommerce div.product p.price, .woocommerce div.product span.price {
	color: {$colors['text_hover']};
}
...
/* Shop mode selector */
.kryptex_shop_mode_buttons a {
	color: {$colors['text_link']};
}
.kryptex_shop_mode_buttons a:hover {
	color: {$colors['text_hover']};
}
.shop_mode_thumbs .kryptex_shop_mode_buttons a.woocommerce_thumbs,
.shop_mode_list .kryptex_shop_mode_buttons a.woocommerce_list {
	color: {$colors['text']};
}
...
.woocommerce div.product div.summary .compare:after {
	color: {$colors['text_hover']};
}
.woocommerce div.product div.summary .compare:hover {
	background-color: {$colors['text_hover']};
	color: {$colors['inverse_link']};
}
.woocommerce div.product div.summary .compare:hover:after {
	color: {$colors['inverse_link']};
}
