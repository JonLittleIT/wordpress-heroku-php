...
<div class="sc_team_item">
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
												...
												'hover' => false,
												'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('med'), 'team-short'),
												'post_info' => ''
												), 'team-short')
								);
	?>
		...
		<div class="sc_team_item_header">
			...
			if($meta['socials']){ ?>
				<div class="sc_team_item_socials socials_wrap trx_addons_hover_info">
					<?php echo trim(trx_addons_get_socials_links_custom($meta['socials'])); ?>
				</div>
			<?php } ?>
