...
jQuery(document).ready(function(){
    ...
    if ( jQuery('.menu-bg-i').length > 0 ) {

        jQuery('.topHeader').addClass('topHeaderShop');

    }

    if ( jQuery('.breadcrumb-fullscreen-parent').length > 0 ) {} else {

        jQuery('.topHeader').addClass('topHeaderShop');

    }

    if ( jQuery('.menu-bg-i-reverse').length > 0 ) {

        jQuery('.topHeader').removeClass('topHeaderShop');
