...
if ( ! class_exists( 'ElitePack_Theme_Updater_Admin' ) ) {
	...
	class ElitePack_Theme_Updater_Admin {
		...
		function is_active(){
			...
			//echo get_option( $this->license_status_key ) .' '.get_option( $this->license_db_key );
                    ...
                    <ul>
						...
						foreach ( $reasons as $reason_id => $the_reason ) {
                            ...
                            <li>
								...
								$description = $this->is_support_active() ? $the_reason['desc_active_support'] : $the_reason['desc_expired_support'];
