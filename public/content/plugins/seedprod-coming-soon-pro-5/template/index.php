...
<head>
    ...
    <?php if(!empty($settings->button_color)): ?>
		...
		@btnDarkColor: darken(@btnColor, 15%);
		.cspio a.btn-primary, .cspio .btn-primary, .cspio .btn-primary:focus, .gform_button, #mc-embedded-subscribe, .mymail-wrapper .submit-button, .mailster-wrapper .submit-button,  input[type='button'].ninja-forms-field {
...
/*    	if(!empty($container_border)){
	...
	<?php
		$css = "
		@primaryColor: {$settings->button_color};
		.cspio a.btn-primary,.cspio .progress-bar, .countdown_section, .cspio .btn-primary,.cspio .btn-primary:focus, .gform_button, .mymail-wrapper .submit-button, .mailster-wrapper .submit-button, input[type='button'].ninja-forms-field{
...
?>
	...
	<?php if(empty($_GET['seed_cspv5_preview']) && ((!empty($settings->enable_reflink) && $settings->enable_reflink == '1')  || (!empty($settings->enable_prize_levels) && $settings->enable_prize_levels == '1'))){ ?>
