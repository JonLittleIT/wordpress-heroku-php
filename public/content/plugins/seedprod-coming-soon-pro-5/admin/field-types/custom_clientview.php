...
echo '<small class="description">Enter a phrase above and give your client or visiors a secret url that will allow them to bypass the Coming Soon page. Use only letter numbers and dashes.<br>After the cookie expires the user will need to revisit the bypass url to regain access.</small><br>';
echo '<strong>Bypass URL: </strong><input id="my_bypass_url" value="'.home_url().'?bypass=" readonly class="regular-text"/><br>';
echo '<small class="description">Above is your bypass URL, copy and it\'s best to test in a Chrome incognito window or a separate browser to simulate an anonymous visitor.</small><br>';
echo '
<script>
