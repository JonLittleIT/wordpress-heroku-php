...
// 	});
    ...
    //Fraud Detection
    if (jQuery('#enable_reflink').is(':checked')) {
        jQuery("#enable_fraud_detection,#enable_prize_levels").parent().show();
    }else{
        jQuery("#enable_fraud_detection,#enable_prize_levels").parent().hide();
    }
    

    jQuery("#enable_reflink").change(function() {
    if(this.checked) {
        jQuery("#enable_fraud_detection,#enable_prize_levels").parent().fadeIn();
    }else{
        jQuery("#enable_fraud_detection,#enable_prize_levels").parent().hide();
    }
    });
...
jQuery(document).ready(function() {
   ...
   jQuery('#refresh_page').on('click',function(e){
	...
	jQuery("#enable_prize_levels,#enable_fraud_detection,#enable_background_overlay,#countdown_launch,#require_name,#container_radius_slider,#progressbar_percentage_slider,#publish_method").change(function() {
	    save_page(false);
	});
