				...
				<div class="container cp-started-content">
					...
					<!-- disable impression -->
							...
							<p>
								<table>
									<tr>
										...
										$uniq            = uniqid();
										?>
										<label for="plugin-support" style="width:340px; display: inline-block;font-size:14px;"><strong><?php _e( 'Lazy Load images', 'smile' ); ?></strong>
							...
							<p>
								<table>
									<tr>
										...
										$uniq             = uniqid();
										?>
										<label for="plugin-support" style="width:340px; display: inline-block;font-size:14px;"><strong><?php _e( 'Close Custom Form', 'smile' ); ?></strong>
						...
						<div class="debug-section">
							...
							?>
							<p>
								<label for="hide-options" style="width:340px; display: inline-block;font-size:14px;"><strong><?php _e( 'Load CSS/JS Asynchronous', 'smile' ); ?></strong>
									<span class="cp-tooltip-icon has-tip" data-position="top" style="cursor: help;" title="<?php _e( 'Enable this option if you wish to load CSS files Asynchronously', 'smile' ); ?>">
										<i class="dashicons dashicons-editor-help"></i>
									</span>
								</label>
								<label class="switch-wrapper" style="display: inline-block;margin: 0;height: 20px;">
						...
						<div class="debug-section">
							...
							?>
							<p>
								<label for="hide-options" style="width:340px; display: inline-block;font-size:14px;"><strong><?php _e( 'Enable Error Notification', 'smile' ); ?></strong>
							...
							?>
								>
								<label for="hide-options" style="width:340px; vertical-align: top; display: inline-block;font-size:14px;"><strong><?php _e( 'Enter Email Id', 'smile' ); ?></strong>
