...
if ( ! function_exists( 'cp_ib_global_before_init' ) ) {
	...
	function cp_ib_global_before_init( $a ) {
		...
		if(class_exists('woocommerce')){$add_to_cart = apply_filters( 'cp_has_enabled_or_disabled', $a['add_to_cart'] );
		}
		...
		<div <?php echo  $infobar_global_data; ?> class="
			<?php
			echo  $class_ifb;
			echo $custom_css_class;
			?>
		" style="min-height:<?php echo esc_attr( $a['infobar_height'] ); ?>px;" data-style-id ="<?php echo $style_id; ?>" data-module-name ="infobar" <?php echo $gr_data; ?>>
